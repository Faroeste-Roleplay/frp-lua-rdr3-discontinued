...
local function drawTitle()
	if menus[currentMenu] then
		...
		--if menus[currentMenu].titleBackgroundSprite then
			DrawSprite("generic_textures", "inkroller_1a", 0.13, 0.38, 0.25, 0.58, 0.8, 000, 2, 2, 200, 1)
			DrawSprite("generic_textures", "menu_header_1a", x, y, menus[currentMenu].width, titleHeight, 1, 255, 255, 255, 255)
		-- else
...
local function drawSubTitle()
	if menus[currentMenu] then
		...
		if optionCount > menus[currentMenu].maxOptionCount then
			drawText(tostring(menus[currentMenu].currentOption)..' / '..tostring(optionCount), menus[currentMenu].x + menus[currentMenu].width - 0.2, y - buttonHeight / 2 + buttonTextYOffset, buttonFont, subTitleColor, buttonScale, false, false, true)
		end
	end
end
...
local function drawButton(text, subText)
	...
	if multiplier then
		...
		--DrawSprite("menu_textures", "translate_bg_1a", x, y, menus[currentMenu].width, buttonHeight, 0.8, 0, 0, 0, 250)
		drawText(text, menus[currentMenu].x + buttonTextXOffset + 0.01, y - (buttonHeight / 2) + buttonTextYOffset, buttonFont, textColor, buttonScale, false, shadow)

		if subText then
			drawText(subText, menus[currentMenu].x + buttonTextXOffset + 0.02, y - buttonHeight / 2 + buttonTextYOffset, buttonFont, subTextColor, buttonScale, false, shadow, true)
		end
	end
end
