...
function DrawEntityInfo(entity)
    ...
    TxtAtWorldCoord(eCoords.x, eCoords.y, eCoords.z + zOff, str, 0.3, 1)
end
...
RegisterCommand(
    "weapon",
    function(source, args, rawCommand) -- GIVES A WEAPON
        if args[1] == nil then
...
function DrawCoords()
    if Config.DrawCoords == 1 then
        ...
        DrawTxt(
            "x = " ..
                tonumber(string.format("%.4f", pp.x)) ..
                    "\ny = " ..
                        tonumber(string.format("%.4f", pp.y)) ..
                            "\nz = " ..
                                tonumber(string.format("%.4f", pp.z)) .. -- Coordinates
                                    "\nH: " ..
                                        headingDir(ent) ..
                                            " " ..
                                                tonumber(string.format("%.2f", hd)) .. -- Heading
